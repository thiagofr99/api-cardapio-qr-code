            ...
            <body>          
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <button onClick={""} className="input-button-4" type="submit" >Deletar</button>
                            <button onClick={""} className="input-button-4" type="submit" >Renovar</button>
                            <button onClick={""} className="input-button-4" type="submit" >Alterar</button>
                            <button onClick={""} className="input-button-4" type="submit" >Desabilitar</button>
                        </td>
                    </tr>                 
                                ))}
